    ...
    function renderGeneratePersona() {
      ...
      return pageWrap("market-page generate-persona-page", `
        ...
        <section class="generate-persona-card generate-persona-visual">
          <img class="generate-persona-img" src="${asset}" alt="${scene.name}生成搭案人格主视觉">
    ...
    function renderLoading() {
      ...
      const mysteryImage = assets.mystery
        ? `<img class="loading-mystery-img" src="${assets.base}${assets.mystery}" alt="">`
      ...
      return pageWrap("loading-page", `
        ...
        <section class="loading-visual-card dashed-card">
          <img class="loading-main-img" src="${assets.base}${assets.main}" alt="${scene.name}搭案人格生成主视觉">
    ...
    function renderResult() {
      ...
      const productList = result.products.map((product, index) => `
        <div class="result-product">
          ${assets.products[index] ? `<img class="result-product-img" src="${assets.base}${assets.products[index]}" alt="">` : `<span>${result.icon}</span>`}
          ${product}
        </div>
      `).join("");
        ...
        <section class="result-card dashed-card" id="resultCard">
          <div class="result-hero">
            <div class="result-media">
              <img class="result-main-img" src="${assets.base}${assets.main}" alt="${scene.name}生活新搭案主视觉">
            </div>
            <div>
