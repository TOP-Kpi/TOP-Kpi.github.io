      ...
      const cards = scenes.map(scene => `
        <button class="scene-card ${userState.selectedScene === scene.id ? "active" : ""}" style="--scene-bg:${scene.bg}" type="button" data-scene="${scene.id}">
          ...
          <span class="scene-visual">
            ${sceneSelectAssets[scene.id] ? `<img class="scene-asset-img" src="${sceneSelectAssets[scene.id]}" alt="">` : scene.icon}
          </span>
          <h3>${scene.name}</h3>
          <p>${scene.sub}</p>
        </button>
    ...
    function renderMarket() {
      const marketAssetMap = {
        clothes: "images/第五页/图层 1.png",
        accessory: "images/第五页/图层 4.png",
        beauty: "images/第五页/图层 3.png",
        toy: "images/第五页/图层 2.png",
        gift: "images/第五页/图层 5.png"
      };
      ...
      return pageWrap("market-page market-assets-page", `
        ${pageTag(5)}
        <img class="market-floating-asset market-cart" src="images/第五页/图层 5.png" alt="">
        <img class="market-floating-asset market-star-a" src="images/第五页/图层 6.png" alt="">
        <img class="market-floating-asset market-star-b" src="images/第五页/图层 7.png" alt="">
        <h1 class="sticker-title tiny"><span class="black">进入</span><span class="mint">三福</span><span class="pink">潮趣市集</span></h1>
        <img class="market-assets-ribbon" src="images/第五页/图层 8.png" alt="点击你想逛的区域">
